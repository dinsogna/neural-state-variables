...
screen -S ROLLOUT -dm bash -c "echo ===========================================================================================;\
                                echo ======================== Long-term model rollout encoder-decoder model ====================;\
                                echo ===========================================================================================;\
                                ...
                                echo;\
                                echo =======================================================================================================;\
                                echo ============== Long-term model rollout encoder-decoder-64 model =======================================;\
                                echo =======================================================================================================;\
                                ...
                                echo;\
                                echo =======================================================================================================;\
                                echo ============== Long-term model rollout refine-64 model  ===============================================;\
                                echo =======================================================================================================;\
                                ...
                                echo;\
                                echo ===========================================================================================;\
                                echo ================================ FINISHED ROLLOUT SINGLE MODEL ============================;\
                                echo ===========================================================================================;\
                                exec sh";

#  screen -S ROLLOUT -dm bash -c "echo TESTING 123; echo; CUDA_VISIBLE_DEVICES="$gpu" python ../pred.py model-rollout ../configs/"$dataset"/model/config1.yaml ./logs_"$dataset"_encoder-decoder_1/lightning_logs/checkpoints NA NA 60";
